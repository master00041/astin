...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Spartacus!\n\nTo get a list of Spartacus groups use /chats or /chatlist for a document list of chats.\n\nTo get a new Spartacus group, contact a support group\n\nThanks for using US!"
     	return text
    end
